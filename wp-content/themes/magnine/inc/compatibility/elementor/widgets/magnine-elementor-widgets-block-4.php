<?php
/**
 * MagNine Elementor Widget Block 4.
 *
 * @package    MagNine
 * @since      MagNine 1.0.0
 */
 ...
 * MagNine Elementor Widget Block 4.
 *
 * Class MagNine_Elementor_Widgets_Block_4
 */
class MagNine_Elementor_Widgets_Block_4 extends Magnine_Elementor_Widget_Base
{

    /**
     * Retrieve MagNine_Elementor_Widgets_Block_4 widget name.
     *
     * @access public
     *
    ...
    {
        return 'MagNine-Posts-Block-4';
    }

    /**
     * Retrieve MagNine_Elementor_Widgets_Block_4 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Block Style 4', 'magnine');
    }
    ...
    /**
     * Retrieve MagNine_Elementor_Widgets_Block_4 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'magnine-econs-block-4';
    }

    /**
     * Retrieve the list of categories the MagNine_Elementor_Widgets_Block_4 widget belongs to.
     *
    ...
    /**
     * Render MagNine_Elementor_Widgets_Block_4 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="magnine-module-block magnine-module-block-style-4 magnine-element-wrapper">
            <?php
