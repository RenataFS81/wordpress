<?php
/**
 * MagNine Elementor Widget Grid 2.
 *
 * @package    MagNine
 * @since      MagNine 1.0.0
 */
 ...
 * MagNine Elementor Widget Grid 2.
 *
 * Class MagNine_Elementor_Widgets_Grid_2
 */
class MagNine_Elementor_Widgets_Grid_2 extends Magnine_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve MagNine_Elementor_Widgets_Grid_2 widget name.
     *
     * @access public
     *
    ...
    {
        return 'MagNine-Posts-Grid-2';
    }

    /**
     * Retrieve MagNine_Elementor_Widgets_Grid_2 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Grid Style 2', 'magnine');
    }

    /**
     * Retrieve MagNine_Elementor_Widgets_Grid_2 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'magnine-econs-grid-2';
    }

    /**
     * Retrieve the list of categories the MagNine_Elementor_Widgets_Grid_2 widget belongs to.
     *
    ...
    /**
     * Render MagNine_Elementor_Widgets_Grid_2 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="magnine-module-grid magnine-module-grid-style-2 magnine-element-wrapper wrapper-gutter-small">
            <?php
            ...
            <div class="row-group">
                ...
                while ($get_featured_posts->have_posts()) :
                    ...
                    $main_div_loop_wrapper_class = 'wpi-post-module-grid wpi-post wpi-tile-post magnine-module-grid--half elementor-custom-column';
                    ...
                    if (1 == $count) {
                        ...
                        $main_div_loop_wrapper_class = 'wpi-post-module-grid wpi-post wpi-tile-post magnine-module-grid--full elementor-custom-column';
                    }
