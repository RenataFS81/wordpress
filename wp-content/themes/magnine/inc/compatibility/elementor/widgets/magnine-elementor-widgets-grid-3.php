<?php
/**
 * MagNine Elementor Widget Grid 3.
 *
 * @package    MagNine
 * @since      MagNine 1.0.0
 */
 ...
 * MagNine Elementor Widget Grid 3.
 *
 * Class MagNine_Elementor_Widgets_Grid_3
 */
class MagNine_Elementor_Widgets_Grid_3 extends Magnine_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve MagNine_Elementor_Widgets_Grid_3 widget name.
     *
     * @access public
     *
    ...
    {
        return 'MagNine-Posts-Grid-3';
    }

    /**
     * Retrieve MagNine_Elementor_Widgets_Grid_3 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Grid Style 3', 'magnine');
    }

    /**
     * Retrieve MagNine_Elementor_Widgets_Grid_3 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'magnine-econs-grid-3';
    }

    /**
     * Retrieve the list of categories the MagNine_Elementor_Widgets_Grid_3 widget belongs to.
     *
    ...
    /**
     * Render MagNine_Elementor_Widgets_Grid_3 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="magnine-module-grid magnine-module-grid-style-3 magnine-element-wrapper wrapper-gutter-small">
            <?php
