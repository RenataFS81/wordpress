<?php
/**
 * MagNine Elementor Widget Grid 5.
 *
 * @package    MagNine
 * @since      MagNine 1.0.0
 */
 ...
 * MagNine Elementor Widget Grid 5.
 *
 * Class MagNine_Elementor_Widgets_Grid_5
 */
class MagNine_Elementor_Widgets_Grid_5 extends Magnine_Elementor_Widget_Base
{
    ...
    /**
     * Retrieve MagNine_Elementor_Widgets_Grid_5 widget name.
     *
     * @access public
     *
    ...
    {
        return 'MagNine-Posts-Grid-5';
    }

    /**
     * Retrieve MagNine_Elementor_Widgets_Grid_5 widget title.
     *
     * @access public
     *
    ...
    {
        return esc_html__('Grid Style 5', 'magnine');
    }

    /**
     * Retrieve MagNine_Elementor_Widgets_Grid_5 widget icon.
     *
     * @access public
     *
    ...
    {
        return 'magnine-econs-grid-5';
    }

    /**
     * Retrieve the list of categories the MagNine_Elementor_Widgets_Grid_5 widget belongs to.
     *
    ...
    /**
     * Render MagNine_Elementor_Widgets_Grid_5 widget output on the frontend.
     *
    ...
    protected function render()
    {
        ...
        <div class="magnine-module-grid magnine-module-grid-style-5 magnine-element-wrapper wrapper-gutter-small">
            <?php
