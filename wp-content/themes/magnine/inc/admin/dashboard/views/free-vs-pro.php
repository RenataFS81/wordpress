...
?>
<div class="magnine-dashboard-content free-vs-pro-page">
    <table class="magnine-compare-table">
        <tbody>
        <?php
        ...
        $features = array(
            ...
            'TG Widgets' => array(
                'showFreePro' => true,
                'items' => array(
                    array('MagNine: Advertisement Widget', $cross_mark, $tick_mark),
                    array('MagNine: Instagram Widget', $cross_mark, $tick_mark),
                    array('MagNine: Author Widget', $tick_mark, $tick_mark),
                    array('MagNine: CTA', $tick_mark, $tick_mark),
                    array('MagNine: Carousel Posts', $tick_mark, $tick_mark),
                    array('MagNine: Categories', $tick_mark, $tick_mark),
                    array('MagNine: Grid Posts', $tick_mark, $tick_mark),
                    array('MagNine: Image Widget', $tick_mark, $tick_mark),
                    array('MagNine: Mailchimp', $tick_mark, $tick_mark),
                    array('MagNine: Metro Post', $tick_mark, $tick_mark),
                    array('MagNine: Recent Posts', $tick_mark, $tick_mark),
                    array('MagNine: Currency Exchange', $cross_mark, $tick_mark),
                    array('MagNine: Google Maps', $cross_mark, $tick_mark),
                    array('MagNine: Weather', $cross_mark, $tick_mark),
                    array('MagNine: Slider Posts', $tick_mark, $tick_mark),
                    array('MagNine: Social Menu', $tick_mark, $tick_mark),
                    array('MagNine: Tab Posts', $tick_mark, $tick_mark),
                    array('MagNine: Youtube Video', $tick_mark, $tick_mark),
                ),
            ),
        ...
        foreach ($features as $category => $feature) :
            ...
            <tr class="compare-table-head">
                ...
                <?php if ($show_free_pro) : ?>
                    <td><?php esc_html_e('Free', 'magnine'); ?></td>
                    <td><?php esc_html_e('Pro', 'magnine'); ?></td>
                <?php endif; ?>
            </tr>
    ...
    <div class="postbox magnine-postbox-upsell">
        <div class="icon">
        ...
        <h3><?php esc_html_e('Upgrade Now', 'magnine'); ?></h3>
        <p><?php echo __('Access all premium extensions, features, and upcoming updates right away by <br> upgrading to the Pro version.', 'magnine'); ?></p>
        <a href="<?php echo esc_url($this->theme_url); ?>#choose-pricing-plan" class="button button-secondary dashboard-button dashboard-button-primary" target="_blank">
            <?php esc_html_e('Get MagNine Pro Now', 'magnine'); ?>
        </a>
    </div>
</div>
