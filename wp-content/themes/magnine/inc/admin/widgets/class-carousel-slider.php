...
class Magnine_Carousel_Slider_Post extends Magnine_Widget_Base
{
    public function __construct()
    {
        $this->widget_cssclass = 'magnine-slider-widget';
        $this->widget_description = __("Displays recent posts in a carousel slider with an image", 'magnine');
        $this->widget_id = 'magnine_carousel_slider_posts';
        $this->widget_name = __('MagNine: Carousel Posts', 'magnine');
    ...
    protected function get_widget_settings()
    {
        return array(
            ...
            'number' => array(
                ...
                'min' => 1,
                'std' => 7,
                'label' => __('Total Number of posts to slider', 'magnine'),
            ),
            'number_of_slides' => array(
                ...
                'max' => 5,
                'std' => 3,
                'label' => __('Number of Slides to show', 'magnine'),
            ),
            'offset' => array(
                'type' => 'number',
                'step' => 1,
            ...
            'centered' => array(
                'type' => 'checkbox',
                'label' => __('Centered Mode', 'magnine'),
                'std' => false,
            ),
            'spacebetween' => array(
                'type' => 'number',
                ...
                'max' => '40',
                'std' => 20,
                'label' => __('Space Between', 'magnine'),
                'desc' => __('Distance between slides in px.', 'magnine'),
            ),
    ...
    protected function get_posts($args, $instance)
    {
        ...
        return new WP_Query(apply_filters('magnine_carousel_slider_posts_query_args', $query_args));
    }
    ...
    public function widget($args, $instance)
    {
        ...
        do_action('magnine_before_carousel_slider_posts_with_image');
        ...
        <?php
        do_action('magnine_after_carousel_slider_posts_with_image');
