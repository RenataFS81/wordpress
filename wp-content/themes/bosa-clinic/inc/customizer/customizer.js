...
( function( $ ) {
	...
	wp.customize( 'bosa_clinic_logo_width', function( value ) {
		value.bind( function( to ) {
			$( '.site-header .site-branding > a' ).css( "max-width", to + 'px' );
		} );
	} );

	wp.customize( 'bosa_clinic_fixed_header_logo_width', function( value ) {
		value.bind( function( to ) {
	...
	// Header text color.
	wp.customize( 'bosa_clinic_header_textcolor', function( value ) {
		value.bind( function( to ) {
			if ( 'blank' === to ) {
	...
	wp.customize( 'bosa_clinic_preloader_custom_image_width', function( value ) {
		value.bind( function( to ) {
	...
	// Header image height
	wp.customize( 'bosa_clinic_header_image_height', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_social_icons_size', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_main_slider_height', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_feature_posts_height', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_bottom_footer_image_width', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_feature_posts_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_highlight_posts_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_transparent_header_banner_post_height', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_transparent_header_banner_page_height', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_latest_posts_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_sale_button_border_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_icon_group_one_border_radius', function( value ) {
	    value.bind( function( to ) {
	        $( 'body[class*=woocommerce] ul.products li .product-compare-wishlist a i' ).css( "borderRadius", to + 'px' );
	    } );
	} );

	wp.customize( 'bosa_clinic_icon_group_two_border_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_icon_group_three_border_radius', function( value ) {
	    value.bind( function( to ) {
	        $( 'body[class*=woocommerce] ul.products li .product-compare-wishlist > div:first-child a i' ).css( "border-top-left-radius", to + 'px' );
	        $( 'body[class*=woocommerce] ul.products li .product-compare-wishlist > div:first-child a i' ).css( "border-bottom-left-radius", to + 'px' );
	        $( 'body[class*=woocommerce] ul.products li .product-compare-wishlist > div:last-child a i' ).css( "border-top-right-radius", to + 'px' );
	...
	wp.customize( 'bosa_clinic_icon_group_four_border_radius', function( value ) {
	    value.bind( function( to ) {
	        $( 'body[class*=woocommerce] ul.products li .product-compare-wishlist a i' ).css( "borderRadius", to + 'px' );
	    } );
	} );
	...
	wp.customize( 'bosa_clinic_shop_product_image_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_shop_product_card_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_add_cart_button_radius', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_cart_four_diagonal_spacing', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_icon_group_diagonal_spacing', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_sale_button_diagonal_spacing', function( value ) {
	    value.bind( function( to ) {
	...
	wp.customize( 'bosa_clinic_woocommerce_product_card_text_alignment', function( value ) {
	    value.bind( function( to ) {
