	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Softme_Customize_Section_Pro(
				...
				'softme',
				array(
                    'pro_text' => esc_html__( 'Upgrade to SoftAlt Pro','softalt' ),
                    'pro_url'  => 'https://desertthemes.com/themes/softalt-pro/',
                    'priority' => 0
                )
			)
		);
...
SoftAlt_Customize::get_instance();